...
const createSendToken = (user, statusCode, res) => {
  ...
  const cookieOptions = {
    ...
    httpOnly: true, // ensure cookie cannot be modified by browser
  };

  if (process.env.NODE_ENV === 'production') {
    cookieOptions.secure == true; // ensures cookie is sent via https ONLY in production NOT development
  }
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
  // User.findByIdAndUpdate will NOT work as intended! Never use this for changing passwords
